...
(function (cartola) {
    ...
    var times = ['JUEDU', 'Bouhid-F-R', 'CAURE-FC', 'JBRASIL90', 'Fogoias85', 'Inimigos-da-Sorte', 'Heezbolah', 'Bucha-E-C',
        'Kbceiras-FC', 'New-Loki-F-C', 'Sir-Borges', 'ALPHA-PREMIER-FC', 'Real-Atheneu-F-C', 'C-A-Dragao', 'Pernislongo',
        'Galo-Alemao', 'Flutigrao', 'WUFC', 'Jacuba-FC', 'Corintiano89', 'R-Noleto-FC'];
    ...
    function montaTime(data) {
        ...
        $('#narnia-table').append('<tr class="' + slug_time + '" data-row="' + slug_time + '" data-total="' + pontos_ordenacao + '"><td colspan="1"><div class="col-xs-12"><img src="' + imgEscudo + '" style="width: 50px;"><img style="width: 30px;position: absolute;left: 45px;top: 25px;" src="' + imgPerfil + '" class="img-circle"></div></td><td colspan="5"><h3>' + nome + '</h3><p>' + nome_cartola + '</p></td><td colspan="2"><p class="ponto" style="text-align: center">' + pontos + '</p></td><td colspan="2" style="text-align: center"><p class="pontoparcial">' + parcial_rodada + '</p></td><td colspan="2" style="text-align: center;"><p class="patrimonio">' + patrimonio + '</p></td></tr>');
        if (atletas_html != '')
